...
# EDUCATIONAL NOTE: [Why] This allows us to stream data asynchronously. Instead of waiting for
...
class BedrockAdapter(BaseLlm):
    ...
    # EDUCATIONAL NOTE: [How] The first argument 'cls' refers to the class itself (BedrockAdapter).
    # EDUCATIONAL NOTE: [Why] This is used here as a "factory-like" mechanism to tell the ADK which
    ...
    # EDUCATIONAL NOTE: [How] It returns an AsyncGenerator object.
    # EDUCATIONAL NOTE: [Why] Essential for "streaming" LLM responses, providing a better user
    ...
    async def generate_content_async(
        ...
        # EDUCATIONAL NOTE: [Why] This allows the caller to iterate over the generator and get
